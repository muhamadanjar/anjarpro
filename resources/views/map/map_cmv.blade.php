...
<html>
    <head>
        ...
        <title>Anjar Map Viewer</title>
        <link rel="stylesheet" type="text/css" href="{{ asset('3.16compact/esri/css/esri.css')}}">
    ...
    <body class="dbootstrap">
        ...
        <![endif]-->
        <script type="text/javascript" src="{{ asset('3.16compact/init.js') }}"></script>
        <script type="text/javascript">
