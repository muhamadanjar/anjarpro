...
<nav class="navbar navbar-fixed-top navbar-default" role="navigation">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <form class="navbar-form navbar-left form-search" id="form-search" role="search">
	        ...
	        <div class="panel-group" id="accordion">
			    ...
			    <div class="panel panel-default">
			        ...
			        <div id="collapseTwo" class="panel-collapse collapse">
			            <div class="panel-body">
			            	<form class="form-search" id="form-search" role="search">
              					<div class="form-group">
			            		<input type="text" class="form-control textSearch" class="form-control" placeholder="Search">
			            		<button type="button" class="btn btn-default btn-search" onClick="updateFilter()">Submit</button>
			            		</div>
			                	<select name="identify" id="identify" class="form-control"></select>
			                </form>
			            </div>
			        </div>
			    </div>
...
<script src="{{ asset('vendor/angular-bootstrap/ui-bootstrap.js')}}"></script>
<script src="{{ asset('vendor/angular-bootstrap/ui-bootstrap-tpls.js')}}"></script>
<script src="{{ asset('lib/app/app.js')}}"></script>
<script src="{{ asset('lib/app/controllers/controllers.js')}}"></script>