            ...
            <div class="col-md-9">        
                ...
                <input type="hidden" name="id_layer" value="">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input id="namalayer" name="namalayer" class="required form-control"/>
                        </div>
                    </div>
                    <div class="form-group">

                        <label for="urllayer" class="col-md-2 control-label">Nama Layer</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input id="source_layer" name="source_layer" value="" class="required form-control source_layer"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="hidden" class="styled" value="0.5" name="layeropacity" id="layeropacity">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2 col-md-2">
                            <input type="text" id="spinner-default" class="form-control" value="1" name="urutan">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="styled form-control" value="1" name="x_min" id="x_min">  
                        </div>
                        <div class="col-md-2">
                            <input type="text" class="styled form-control" value="1" name="y_min" id="y_min">
                        </div>
                        <div class="col-md-2">
                            <input type="text" class="styled form-control" value="1" name="x_max" id="x_max">
                        </div>
                        <div class="col-md-2">
                            <input type="text" class="styled form-control" value="1" name="y_max" id="y_max">
                        </div>
                        <div class="col-md-2">
