		...
		<div class="row">
            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                 <textarea id="postcontent" class="tinymce_anjarpro" name="postcontent" class="form-control"></textarea>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <input id="created_at" class="form-control datepicker" placeholder="Dari Tanggal" name="created_at">
                        <!--<input id="updated_at" class="form-control datepicker" placeholder="Sampai Tanggal" name="updated_at">-->
